...
####Hypotheses
Extreme precipitation events result in increased N, P, C leaching.

Extreme precipitation events result in increased incomplete denitrification.
...
This is a flow chart describing my research. Climate change impacts the frequency of extreme events which I hypothesize impacts soil microbial populations and therefore enzymatic activity. These things in turn influence nutrient cycling and eutrophication in Lake Champlain. In my research, we apply this model to an agricultural riparian zone.
