...
Question 1 and 2, finishing the file building and stats code from class.
```{r}
...
Trying to break the code here....
To do this, I simply increased the number of NA values in each file from 3 to 30. This gave a bunch of errors and in my run only created four excel files. The summary stats .csv just gave NA values for the rest of the files and it seems to repeat files 1-4 25 times.
```{r}
# # Create 100 random data sets
# FileBuilder(fileN=nFiles,
#             fileNA = 30)
