...
This code rarefies the data. As far as I understand it, this essentially standardizes the microbial taxa data to the lowest number of sequences across samples. Also shown is the structure of the data.
```{r}
